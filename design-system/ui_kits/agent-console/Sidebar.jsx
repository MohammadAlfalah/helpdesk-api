  ...
  return (
    <aside style={{
      ...
      <div style={{ marginTop: 'auto', display: 'flex', alignItems: 'center', gap: 10, padding: '10px 8px', borderTop: '1px solid var(--border-subtle)' }}>
        <Avatar name="Dana Okafor" role="Agent" size="sm" />
        <div style={{ minWidth: 0 }}>
          <div style={{ font: 'var(--font-label)', color: 'var(--text-strong)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>Dana Okafor</div>
          <div style={{ font: 'var(--font-small)', color: 'var(--text-muted)' }}>Agent</div>
        </div>
      </div>
    </aside>
  );
